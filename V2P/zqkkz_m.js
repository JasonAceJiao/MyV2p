/*
修改自 shaolin-kongfu，本脚本执行body末尾num指定值之body个数，请修改第一行变量值以改变个数
*/
let num = 2  // ##修改此处num值以执行末尾几个body，num=5：末尾5个body
...
!(async () => {
    if (typeof $request !== "undefined") {
        ...
        for (let k = zqlookStartbodyArr.length - num; k < zqlookStartbodyArr.length; k++) {
